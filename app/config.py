...
_MAP_BOUNDS_MIN_LAT = float(os.getenv("MAP_BOUNDS_MIN_LAT", "36.10"))
_MAP_BOUNDS_MAX_LAT = float(os.getenv("MAP_BOUNDS_MAX_LAT", "36.30"))
_MAP_BOUNDS_MIN_LNG = float(os.getenv("MAP_BOUNDS_MIN_LNG", "36.95"))
_MAP_BOUNDS_MAX_LNG = float(os.getenv("MAP_BOUNDS_MAX_LNG", "37.30"))
